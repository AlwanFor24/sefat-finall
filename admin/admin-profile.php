  ...
  if(isset($_POST['change_pwd']))
    {
            ...
            $a_nomorinduk=$_POST['a_nomorinduk'];
            $query=" UPDATE tms_admin SET a_name = ?, a_email=?, a_pwd=?,  a_nomorinduk=?  WHERE a_id = ?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('sssii', $a_name,$a_email,$a_pwd, $a_nomorinduk, $a_pwd, $aid);
            $stmt->execute();
                if($stmt)
                {
